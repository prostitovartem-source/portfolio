...
const projects = [
  ...
  {
    title: "ALTME AI 🍓",
    desc: "AI-сервис для генерации и редактирования изображений. Реализованы загрузка фотографий, выбор AI-стилей, система внутренней валюты 🍓, история генераций и современный интерфейс на Next.js.",

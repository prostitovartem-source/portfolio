...
const projects = [
  {
    title: "Quantix",
    desc: "AI SaaS-платформа для автоматизации учета товаров и обработки накладных. Распознает документы с помощью AI, извлекает данные и помогает управлять складскими операциями.",
    tag: "Next.js • AI • Prisma",
    link: "https://quantix-five.vercel.app",
  },
  {
    title: "ALTME AI 🍓",
    desc: "AI-платформа для создания и редактирования изображений. Пользователь загружает фото, выбирает стиль и получает результат через AI-модели. Реализованы система кредитов, история генераций и современный UX-интерфейс.",
